...
<head>
    ...
    <style>
        :root {
            ...
            --glass-sidebar: rgba(20, 20, 20, 0.9);
        ...
        * { box-sizing: border-box; transition: 0.3s; }
        ...
        .btn-edit { color: #2196f3; font-weight: bold; margin-right: 10px; }
        .btn-delete { color: #ef5350; font-weight: bold; }
    </style>
</head>
...
<div class="main-content">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
        ...
        <a href="admin_post.html" class="btn-create">
...
<script>
    ...
    fetch("get_notices.php")
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                body.innerHTML = "<tr><td colspan='5'>No notices found</td></tr>";
                return;
            }
            ...
            data.forEach(n => {
                body.innerHTML += `
                    <tr>
                        ...
                        <td>${n.priority ?? "-"}</td>
                        <td>
                            <a href="edit_notice.php?id=${n.notice_id}" class="btn-edit">Edit</a>
                            <a href="delete_notice.php?id=${n.notice_id}" class="btn-delete"
        ...
        .catch(err => {
            document.getElementById("noticesBody").innerHTML =
                "<tr><td colspan='5'>Failed to load notices</td></tr>";
            console.error(err);
        });
</script>
